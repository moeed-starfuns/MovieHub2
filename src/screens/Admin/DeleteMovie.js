...
const SearchMovie = ({ navigation }) => {
    ...
    const deletee = (key) => {
        ...
        firestore()
            ...
            .catch(err => Alert.alert('Unable to Delete'))
    }
    ...
    return (
        ...
        >
            <SafeAreaView style={styles.container}>
                {/* <Text style={styles.header}>Delete Movie</Text> */}
                        ...
                        renderItem={({ item }) => (
                            <View style={styles.movieItem}>
                                ...
                                <View style={styles.delete}>
                                    <TouchableOpacity onPress={() => (deletee(item.key))}>
                                        <Icon name="trash" size={30} color="#a12d25" />
